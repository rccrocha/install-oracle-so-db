...
##############################################
"
mkdir -p /ora/wiki/app/oracle/base/oh
chown oracle:oinstall -R /ora
ls -la /ora/wiki/app/oracle/base/oh
...
export ORACLE_UNQNAME=OWIKIT
export ORACLE_BASE=/ora/wiki/app/oracle/base
export ORACLE_HOME=$ORACLE_BASE/oh
export ORACLE_SID=WIKIT
...
cd /home/raphael
cp oracle_silent_install_oracle.sh /home/oracle/oracle_silent_install_oracle.sh
cp deploy_2.sh /home/oracle/deploy_2.sh
rsync -ah --progress LINUX.X64_193000_db_home.zip /home/oracle/linux_db.zip

chown -R oracle. /home/oracle
chmod +x /home/oracle/oracle_silent_install_oracle.sh
chmod +x /home/oracle/deploy_2.sh
...
sudo -u oracle -s /bin/sh -c "/home/oracle/deploy_2.sh"
